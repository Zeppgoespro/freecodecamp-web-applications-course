...
--
-- Хост: mysql-wa4e
-- Время создания: Сен 12 2023 г., 19:20
...
-- База данных: `albums`
--
CREATE DATABASE IF NOT EXISTS `albums` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `albums`;
...
INSERT INTO `albums` (`album_id`, `title`, `year`, `songs`) VALUES
(2, 'in Rock', 1970, 7),
(3, 'Physical Graffiti', 1975, 15),
(4, 'Crises', 1983, 7),
(5, 'Rattle That Lock', 2015, 10),
(6, 'The Dark Side of the Moon', 1973, 10),
(7, 'Are You Experienced', 1967, 17),
(8, 'Abbey Road', 1969, 17),
(9, 'Back in Black', 1980, 10);
...
(1, 'Boba', 'boba@bookex.com', '123'),
(2, 'Jabba', 'jabba@bookex.com', '456'),
(11, 'Frodor', 'frodor@bookex.com', '777'),
(16, 'Bobr', 'bobr@bookex.com', '999'),
(17, 'Zenna', 'zenna@bookex.com', '1234'),
(19, 'Franklin', 'frank@bookex.com', '1222'),
(20, 'Gingle', 'ging@bookex.com', '1223'),
(22, 'Sam', 'sam@bookex.com', '5555'),
(26, 'Cringe', 'cringe@bookex.com', '8888');
...
--
CREATE DATABASE IF NOT EXISTS `new_misc` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `new_misc`;
